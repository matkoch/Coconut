...
namespace Coconut.Debugging
{
    public static class BreakpointExtensions
    {
        ...
        public static IDeclaredElement GetDeclaredElement (this IBreakpoint breakpoint, IPsiSourceFile file)
        {
            ...
            var functionNameWithoutParameterList = parenthesisIndex != -1
                ? breakpoint.FunctionName.Substring(startIndex: 0, length: parenthesisIndex)
            ...
            var paramterValues = breakpoint.FunctionName.Substring(parenthesisIndex + 1)
                    .Trim(')')
